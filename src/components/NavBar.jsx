export default function NavBar() {
  return (
    <div className="font-rajdhani w-full h-20 flex justify-between items-center text-white">
      <a className="ml-10 lg:ml-0 text-2xl font-bold cursor-pointer transition-all hover:text-purple-400">_mylo</a>
