...
export default function Projects() {
  return (
    <div id="projects" className="max-w-5xl h-screen pt-20 bg-transparent mx-auto">
      <h2 className="text-white text-4xl md:text-5xl font-semibold text-center">Some of my projects</h2>
      <Swiper
        navigation={true}
        grabCursor={true}
        effect={'creative'}
      ...
      >
        <SwiperSlide className='flex flex-col items-center'>
          <div className="z-50 translate-y-5 md:translate-y-12 w-[270px] md:w-[550px] rounded-lg shadow">
          ...
          <div className="w-[80%] relative lg:w-[75%] h-80 lg:h-56 flex flex-col justify-center lg:items-center lg:flex-row gap-5 px-10 bg-[#010409] text-white shadow shadow-gray-500 rounded-xl">
            <div>
              <h2 className="text-left text-3xl md:text-5xl">Mylommerce</h2>
            ...
            <div className="w-auto lg:mt-5 text-sm flex flex-col">
              ...
              <a className="absolute bottom-5 right-5" href="https://mylo-ecommerce.vercel.app/" target='_blank'><ExternalLinkSVG /></a>
